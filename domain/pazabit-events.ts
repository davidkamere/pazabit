...
export type AudioAttachment = { data: ArrayBuffer; durationSec: number; mimeType: string };
export type ReportEvent = { kind: "report"; eventId: string; createdAt: number; body: string; flag: Flag; groups: string[]; arrival?: Arrival; audio?: AudioAttachment };
...
export type GroupCreatedEvent = { kind: "group-created"; eventId: string; createdAt: number; group: Group; password: string };
